...
export type DeleteRequestHandler<ReplyPayload> = RouteHandlerMethod<void, void, ReplyPayload>;
export type GetRequestHandler<ReplyPayload> = RouteHandlerMethod<void, void, ReplyPayload>;
export type PostRequestHandler<Payload, ReplyPayload> = RouteHandlerMethod<Payload, void, ReplyPayload>;
export type PatchRequestHandler<Payload, ReplyPayload> = RouteHandlerMethod<Payload, void, ReplyPayload>;
export type PutRequestHandler<Payload, ReplyPayload> = RouteHandlerMethod<Payload, void, ReplyPayload>;
